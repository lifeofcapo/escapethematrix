...
export const privacyTranslations = {
  ...
  en: {
    ...
    metaTitle: "Privacy Policy — EscapeTheMatrix VPN",
    metaDesc: "EscapeTheMatrix VPN Privacy Policy. Zero logs — we collect no user data whatsoever.",
    sections: [
      { h: "1. General Provisions", p: "EscapeTheMatrix (hereinafter — \"Service\", \"we\") does not collect or store personal data of users. We do not maintain connection logs, do not record IP addresses, do not track browsing history, and do not analyze user traffic. Our infrastructure is built to technically exclude the possibility of collecting such information." },
  ...
  es: {
    ...
    metaTitle: "Política de Privacidad — EscapeTheMatrix VPN",
    metaDesc: "Política de privacidad de EscapeTheMatrix VPN. Zero logs — no recopilamos ningún dato de usuario.",
    sections: [
      { h: "1. Disposiciones Generales", p: "EscapeTheMatrix (en adelante, «Servicio», «nosotros») no recopila ni almacena datos personales de los usuarios. No mantenemos registros de conexión, no registramos direcciones IP, no rastreamos el historial de navegación ni analizamos el tráfico de los usuarios." },
  ...
  de: {
    ...
    metaTitle: "Datenschutzerklärung — EscapeTheMatrix VPN",
    metaDesc: "Datenschutzerklärung von EscapeTheMatrix VPN. Zero Logs — wir erheben keinerlei Nutzerdaten.",
    sections: [
      { h: "1. Allgemeine Bestimmungen", p: "EscapeTheMatrix (nachfolgend Dienst, wir) erhebt und speichert keine personenbezogenen Daten der Nutzer. Wir führen keine Verbindungsprotokolle, erfassen keine IP-Adressen, verfolgen keinen Browserverlauf und analysieren keinen Nutzerverkehr." },
  ...
  zh: {
    ...
    metaTitle: "隐私政策 — EscapeTheMatrix VPN",
    metaDesc: "EscapeTheMatrix VPN隐私政策。零日志——我们不收集任何用户数据。",
    sections: [
      { h: "1. 总则", p: "EscapeTheMatrix（以下简称`服务`、`我们`）不收集或存储用户个人数据。我们不维护连接日志，不记录IP地址，不跟踪浏览历史，不分析用户流量。我们的基础设施在技术上排除了收集此类信息的可能性。" },
...
export const termsTranslations = {
  ru: {
    ...
    updated: "Последнее обновление: 09.04.2026",
    metaTitle: "Условия использования — EscapeTheMatrix VPN",
    metaDesc: "Условия использования сервиса EscapeTheMatrix VPN. Права и обязанности пользователей.",
    sections: [
      { h: "1. Предмет соглашения", p: "Настоящие Условия использования регулируют отношения между EscapeTheMatrix (далее — «Сервис») и пользователем при использовании сайта escapethematrix.to и связанных с ним услуг VPN." },
  ...
  en: {
    ...
    updated: "Last updated: 09.04.2026",
    metaTitle: "Terms of Service — EscapeTheMatrix VPN",
    metaDesc: "Terms of Service for EscapeTheMatrix VPN. User rights and obligations.",
    sections: [
      { h: "1. Subject of Agreement", p: "These Terms of Service govern the relationship between EscapeTheMatrix (\"Service\") and the user when using the site escapethematrix.to and related VPN services." },
  ...
  es: {
    ...
    updated: "Última actualización: 09.04.2026",
    metaTitle: "Términos de Servicio — EscapeTheMatrix VPN",
    metaDesc: "Términos de servicio de EscapeTheMatrix VPN. Derechos y obligaciones de los usuarios.",
    sections: [
      { h: "1. Objeto del Acuerdo", p: "Estos Términos de Servicio rigen la relación entre EscapeTheMatrix («Servicio») y el usuario al usar el sitio escapethematrix.to y los servicios VPN relacionados." },
  ...
  de: {
    ...
    updated: "Letzte Aktualisierung: 09.04.2026",
    metaTitle: "Nutzungsbedingungen — EscapeTheMatrix VPN",
    metaDesc: "Nutzungsbedingungen für EscapeTheMatrix VPN. Rechte und Pflichten der Nutzer.",
    sections: [
      { h: "1. Vertragsgegenstand", p: "Diese Nutzungsbedingungen regeln die Beziehung zwischen EscapeTheMatrix («Dienst») und dem Nutzer bei der Verwendung der Website escapethematrix.to und der damit verbundenen VPN-Dienste." },
  ...
  zh: {
    title: "服务条款",
    updated: "最后更新：09.04.2026",
    metaTitle: "服务条款 — EscapeTheMatrix VPN",
    metaDesc: "EscapeTheMatrix VPN服务条款。用户权利和义务。",
    sections: [
      { h: "1. 协议主题", p: "本服务条款规范EscapeTheMatrix（`服务`）与用户在使用网站escapethematrix.to及相关VPN服务时的关系。" },
...
export const translations = {
  ru: {
    ...
    pricing: {
      title: "Тарифы",
      sub: "Один план. Два региона. Три способа обхода. Полная свобода.",
      includedTitle: "Включено в подписку",
      protocolsNote: "Все три протокола доступны одновременно — переключайся прямо в приложении, если один заблокирован.",
      ...
      protocols: [
        { icon: "◎", name: "VLESS Reality", sub: "gRPC" },
        { icon: "◈", name: "VLESS Reality", sub: "XHTTP" },
        { icon: "◬", name: "Hysteria", sub: "мобильный обход" },
      ],
      plans: [
        { period: "1 месяц", price: 100, perMonth: null, badge: null },
        { period: "3 месяца", price: 290, perMonth: 97, badge: "Выгодно" },
        { period: "6 месяцев", price: 580, perMonth: 97, badge: "Максимум" },
      ],
    },
    payment: {
    ...
    profile: {
      login: {
        loginTitle: "Вход",
        loginSub: "Введите ключ профиля для доступа",
        placeholder: "Ключ профиля",
        btn: "Войти",
        loading: "Проверка...",
        error: "Неверный ключ",
        getKey: "Получить ключ в Telegram боте",
        signingIn: "Вход...",
        continueWithGoogle: "Войти через Google",
        signInWithProfileKey: "Войти по ключу профиля",
        back: "Назад",
        or: "или",
      },
      payment: {
      ...
      vpnClients: {
        title: "VPN-клиенты",
        subtitle: "Скачайте приложение для вашего устройства",
        download: "Скачать",
        guide: "Инструкция",
      },
      dashboard: {
        buyTitle: "Купить подписку",
        renewTitle: "Продлить подписку",
        selectPlan: "Выберите план",
        balance: "Баланс",
        notEnough: "Недостаточно средств",
        buyBtn: "Купить за",
        renewBtn: "Продлить за",
        topupFirst: "Пополнить баланс →",
        clients: "VPN клиенты",
        configs: "Конфигурации",
        noSub: "Нет активной подписки",
        getSub: "Получить подписку →",
        greeting: "личный кабинет",
        status: "Статус",
        active: "Активна",
        expired: "Истекла",
        inactive: "Неактивна",
        expires: "Истекает",
        daysLeft: (n: number) => `ещё ${n} дн.`,
        expiresSoon: (n: number) => `⚠ Подписка истекает через ${n} дн.`,
        ...
        rub: "₽",
        key: "Ключ профиля",
        purchaseOk: "✓ Подписка активирована",
        purchaseProcessing: "Обработка...",
        insufficientBalance: "Пополните баланс для покупки",
        selectRegion: "Выберите регион",
        regionFi: "🇫🇮 Финляндия",
        regionNl: "🇳🇱 Нидерланды",
        availableDevices: "доступных устройств",
        referralTitle: "Реферальная программа",
        referralSub: "Приглашайте друзей и получайте 25% от каждого их пополнения баланса.",
        invited: "Приглашено:",
      },
    },
    footer: {
      tagline: "EscapeTheMatrix",
  ...
  en: {
    ...
    pricing: {
      title: "Pricing",
      sub: "One plan. Two regions. Three bypass methods. Total freedom.",
      includedTitle: "Included in subscription",
      protocolsNote: "All three protocols available simultaneously — switch right in the app if one gets blocked.",
      ...
      protocols: [
        { icon: "◎", name: "VLESS Reality", sub: "gRPC" },
        { icon: "◈", name: "VLESS Reality", sub: "XHTTP" },
        { icon: "◬", name: "Hysteria", sub: "mobile bypass" },
      ],
      plans: [
        { period: "1 month", price: 100, perMonth: null, badge: null },
        { period: "3 months", price: 290, perMonth: 97, badge: "Best value" },
        { period: "6 months", price: 580, perMonth: 97, badge: "Max savings" },
      ],
    },
    payment: {
    ...
    profile: {
      login: {
        loginTitle: "Login",
        loginSub: "Enter your profile key to access",
        placeholder: "Profile key",
        btn: "Sign in",
        loading: "Checking...",
        error: "Invalid key",
        getKey: "Get key in Telegram bot",
        signingIn: "Signing in...",
        continueWithGoogle: "Sign in with Google",
        signInWithProfileKey: "Sign in with profile key",
        back: "Back",
        or: "or"
      },
      payment: {
      ...
      vpnClients: {
        title: "VPN Clients",
        subtitle: "Download the app for your device",
        download: "Download",
        guide: "Guide"
      },
      dashboard: {
        buyTitle: "Buy subscription",
        ...
        buyBtn: "Buy for",
        renewBtn: "Renew for",
        topupFirst: "Top up balance →",
        clients: "VPN clients",
        configs: "Configurations",
        noSub: "No active subscription",
        getSub: "Get subscription →",
        greeting: "Dashboard",
        status: "Status",
        active: "Active",
        expired: "Expired",
        ...
        expiresSoon: (n: number) => `⚠ Subscription expires in ${n} day${n === 1 ? '' : 's'}`,
        ...
        rub: "₽",
        key: "Profile key",
        purchaseOk: "✓ Subscription activated",
        ...
        referralSub: "Invite friends and get 25% from every balance top-up they make.",
        invited: "Invited:",
      }
    },
    footer: {
  ...
  es: {
    ...
    pricing: {
      title: "Precios",
      sub: "Un plan. Dos regiones. Tres métodos de evasión. Libertad total.",
      includedTitle: "Incluido en la suscripción",
      protocolsNote: "Los tres protocolos están disponibles a la vez — cambia directamente en la app si uno es bloqueado.",
      ...
      period6: "6 meses",
      perMonthShort: "₽ / mes",
      badgePopular: "Mejor precio",
      badgeMax: "Máximo ahorro",
      cta: "Conectar",
      regions: [
      ...
      protocols: [
        { icon: "◎", name: "VLESS Reality", sub: "gRPC" },
        { icon: "◈", name: "VLESS Reality", sub: "XHTTP" },
        { icon: "◬", name: "Hysteria", sub: "evasión móvil" },
      ],
      plans: [
        { period: "1 mes", price: 100, perMonth: null, badge: null },
        { period: "3 meses", price: 290, perMonth: 97, badge: "Mejor precio" },
        { period: "6 meses", price: 580, perMonth: 97, badge: "Máximo ahorro" },
      ],
    },
    payment: {
    ...
    profile: {
      login: {
        ...
        loginSub: "Ingrese su clave de perfil para acceder",
        placeholder: "Clave de perfil",
        btn: "Entrar",
        loading: "Verificando...",
        error: "Clave no válida",
        getKey: "Obtener clave en el bot de Telegram",
        signingIn: "Iniciando sesión...",
        continueWithGoogle: "Iniciar sesión con Google",
        signInWithProfileKey: "Iniciar sesión con clave de perfil",
        back: "Atrás",
        or: "o"
      },
      payment: {
        ...
        amount: "Importe",
        amountPlaceholder: "Ingrese el monto en rublos",
        pay: "Pagar",
        cancel: "Cancelar",
        loading: "Creando pago...",
        yookassa: "Tarjeta / SBP",
        crypto: "Criptomoneda",
        selectCrypto: "Seleccione criptomoneda",
        cryptoNote: "El saldo se recargará automáticamente después del pago",
        minAmount: "Mínimo 100 ₽",
        errorAmount: "Ingrese un monto válido",
        errorPayment: "Error al crear el pago. Inténtelo de nuevo más tarde.",
        rubSymbol: "₽",
        chooseAmount: "Selección rápida",
        success: "Pago creado",
      },
      vpnClients: {
        title: "Clientes VPN",
        subtitle: "Descargue la aplicación para su dispositivo",
        download: "Descargar",
        guide: "Guía"
      },
      dashboard: {
        buyTitle: "Comprar suscripción",
        renewTitle: "Renovar suscripción",
        selectPlan: "Seleccionar plan",
        balance: "Saldo",
        notEnough: "Saldo insuficiente",
        buyBtn: "Comprar por",
        renewBtn: "Renovar por",
        topupFirst: "Recargar saldo →",
        clients: "Clientes VPN",
        configs: "Configuraciones",
        noSub: "Sin suscripción activa",
        getSub: "Obtener suscripción →",
        greeting: "Panel personal",
        status: "Estado",
        active: "Activa",
        expired: "Expirada",
        inactive: "Inactiva",
        ...
        expiresSoon: (n: number) => `⚠ La suscripción vence en ${n} día${n === 1 ? '' : 's'}`,
        ...
        rub: "₽",
        key: "Clave de perfil",
        purchaseOk: "✓ Suscripción activada",
        purchaseProcessing: "Procesando...",
        insufficientBalance: "Recargue saldo para comprar",
        selectRegion: "Seleccionar región",
        regionFi: "🇫🇮 Finlandia",
        regionNl: "🇳🇱 Países Bajos",
        availableDevices: "dispositivos disponibles",
        referralTitle: "Programa de referidos",
        referralSub: "Invita a tus amigos y recibe el 25% de cada recarga que hagan.",
        invited: "Invitados:",
      }
    },
    footer: {
  ...
  de: {
    ...
    pricing: {
      title: "Preise",
      sub: "Ein Plan. Zwei Regionen. Drei Umgehungsmethoden. Volle Freiheit.",
      includedTitle: "Im Abonnement enthalten",
      protocolsNote: "Alle drei Protokolle sind gleichzeitig verfügbar — wechsle direkt in der App, falls eines blockiert wird.",
      ...
      period6: "6 Monate",
      perMonthShort: "₽ / Monat",
      badgePopular: "Bester Preis",
      badgeMax: "Max. Ersparnis",
      cta: "Verbinden",
      regions: [
      ...
      protocols: [
        { icon: "◎", name: "VLESS Reality", sub: "gRPC" },
        { icon: "◈", name: "VLESS Reality", sub: "XHTTP" },
        { icon: "◬", name: "Hysteria", sub: "mobile Umgehung" },
      ],
      plans: [
        { period: "1 Monat", price: 100, perMonth: null, badge: null },
        { period: "3 Monate", price: 290, perMonth: 97, badge: "Bester Preis" },
        { period: "6 Monate", price: 580, perMonth: 97, badge: "Max. Ersparnis" },
      ],
    },
    payment: {
    ...
    profile: {
      login: {
        loginTitle: "Anmelden",
        loginSub: "Geben Sie Ihren Profilschlüssel ein, um zuzugreifen",
        placeholder: "Profilschlüssel",
        btn: "Anmelden",
        loading: "Prüfung...",
        error: "Ungültiger Schlüssel",
        getKey: "Schlüssel im Telegram-Bot erhalten",
        signingIn: "Anmeldung...",
        continueWithGoogle: "Mit Google anmelden",
        signInWithProfileKey: "Mit Profilschlüssel anmelden",
        back: "Zurück",
        or: "oder",
        success: "Zahlung erstellt",
      },
      payment: {
      ...
      vpnClients: {
        title: "VPN-Clients",
        subtitle: "Laden Sie die App für Ihr Gerät herunter",
        download: "Herunterladen",
        guide: "Anleitung"
      },
      dashboard: {
        buyTitle: "Abonnement kaufen",
        renewTitle: "Abonnement verlängern",
        selectPlan: "Plan auswählen",
        balance: "Guthaben",
        notEnough: "Nicht genügend Guthaben",
        buyBtn: "Kaufen für",
        renewBtn: "Verlängern für",
        topupFirst: "Guthaben aufladen →",
        clients: "VPN-Clients",
        configs: "Konfigurationen",
        noSub: "Kein aktives Abonnement",
        getSub: "Abonnement holen →",
        greeting: "Dashboard",
        status: "Status",
        active: "Aktiv",
        expired: "Abgelaufen",
        ...
        expiresSoon: (n: number) => `⚠ Abonnement läuft in ${n} Tag${n === 1 ? '' : 'en'} ab`,
        ...
        rub: "₽",
        key: "Profilschlüssel",
        purchaseOk: "✓ Abonnement aktiviert",
        purchaseProcessing: "Verarbeitung...",
        insufficientBalance: "Guthaben aufladen, um zu kaufen",
        selectRegion: "Region auswählen",
        regionFi: "🇫🇮 Finnland",
        regionNl: "🇳🇱 Niederlande",
        availableDevices: "verfügbare Geräte",
        referralTitle: "Partnerprogramm",
        referralSub: "Laden Sie Freunde ein und erhalten Sie 25% von jeder ihrer Aufladungen.",
        invited: "Eingeladen:",
      }
    },
    footer: {
  ...
  zh: {
    ...
    pricing: {
      title: "价格",
      sub: "一个套餐。两个地区。三种绕过方式。完全自由。",
      includedTitle: "订阅内容",
      protocolsNote: "三种协议同时可用 — 如果一种被封锁，可在应用内直接切换。",
      regionsTitle: "地区",
      month: "/ 月",
      periodMonth: "1个月",
      period3: "3个月",
      ...
      protocols: [
        { icon: "◎", name: "VLESS Reality", sub: "gRPC" },
        { icon: "◈", name: "VLESS Reality", sub: "XHTTP" },
        { icon: "◬", name: "Hysteria", sub: "移动端绕过" },
      ],
      plans: [
        { period: "1个月", price: 100, perMonth: null, badge: null },
        { period: "3个月", price: 290, perMonth: 97, badge: "性价比最高" },
        { period: "6个月", price: 580, perMonth: 97, badge: "最大节省" },
      ],
    },
    payment: {
      title: "支付方式"
    ...
    profile: {
      login: {
        loginTitle: "登录",
        loginSub: "输入您的配置文件密钥以访问",
        placeholder: "配置文件密钥",
        btn: "登录",
        loading: "验证中...",
        error: "无效密钥",
        getKey: "在 Telegram 机器人中获取密钥",
        signingIn: "登录中...",
        continueWithGoogle: "使用 Google 登录",
        signInWithProfileKey: "使用配置文件密钥登录",
        back: "返回",
        or: "或"
      },
      payment: {
      ...
      dashboard: {
        ...
        insufficientBalance: "充值后再购买",
        selectRegion: "选择地区",
        regionFi: "🇫🇮 芬兰",
        regionNl: "🇳🇱 荷兰",
        availableDevices: "可用设备",
        referralTitle: "推荐计划",
        referralSub: "邀请好友，每次他们充值时您可获得 25% 奖励。",
        invited: "已邀请：",
      }
    },
    footer: {
