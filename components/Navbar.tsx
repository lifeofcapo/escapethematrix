      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
          ...
          {isAuthenticated ? (
            <button
              onClick={onLogout}
              className="flex items-center px-3 sm:px-5 py-2 border border-red-400/20 text-red-400/60 font-mono text-xs sm:text-sm tracking-wider uppercase hover:border-red-400/50 hover:text-red-400 transition-all rounded-sm whitespace-nowrap"
            >
